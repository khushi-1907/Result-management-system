     ...
     <div class="container">
      ...
      <br />
        <div class="panel panel-default">
          <div class="panel-heading">Import Subject From Excel or CSV File (With syntax: Column[1] = Subject ID; Column[2] = Subject Name; Column[3] = Branch Code; Column[4] = Semester in digits)</div>
