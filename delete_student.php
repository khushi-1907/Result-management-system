...
<body>
  ...
  <section class="home-section">
    <nav>
      <div class="sidebar-button">
        ...
        <span class="dashboard">Delete Student</span>
      </div>
    </nav>
    <center>
  ...
  <?php
    if(isset($_POST['roll_no'],$_POST['branch_code'],$_POST['semester'])) {
        $roll_no=$_POST['roll_no'];
        $branch_code=$_POST['branch_code'];
        $semester=$_POST['semester'];
        $delete_sql=mysqli_query($conn,"DELETE from `student` where `roll_number`='$roll_no' and `branch_code`='$branch_code'and `semester`='$semester'");
        if(!$delete_sql){
