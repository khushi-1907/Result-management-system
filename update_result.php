  ...
  <section class="home-section">
    <nav>
      <div class="sidebar-button">
        ...
        <span class="dashboard">Update Result</span>
      </div>
    </nav>
    <center>
    <div class="card registerform">
        <form action="update_result.php" method="POST">
          ...
          <div class="form-group">
            ...
            <input type="number" class="form-control" placeholder="Enter Updated Marks" name="marks">
          </div>
...
<?php 
include('init.php');
  if (isset($_POST['roll_no'],$_POST['subject_id'],$_POST['marks'])) {
    $roll_no=$_POST["roll_no"];
    $subject_id=$_POST["subject_id"];
    $marks=$_POST["marks"];

    $sql = "UPDATE `result` SET `marks` = '$marks' WHERE `roll_number`='$roll_no' and `subject_id`='$subject_id'";
