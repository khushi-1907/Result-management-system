  ...
  <section class="home-section">
    <nav>
      <div class="sidebar-button">
        ...
        <span class="dashboard">Add result</span>
      </div>
    </nav>
    <center>
    <div class="card registerform">
        <form action="add_result.php" method="POST">
          ...
          <div class="form-group">
            <label>Marks</label>
            <input type="number" class="form-control" placeholder="Enter Marks" name="marks">
          </div>
...
include('init.php');
  if (isset($_POST['roll_no'],$_POST['subject_id'],$_POST['marks'])) {
    ...
    $sql = "INSERT INTO `result` (`roll_number`, `subject_id`,`marks`) VALUES ('$roll_no', '$subject_id','$marks')";
